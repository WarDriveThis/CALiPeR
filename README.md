...
Currently built for Raspberry PI 4 B with compatible connected camera and Waveshare 7.5 inch e-paper display. Other platforms and displays certainly possible. 7.5 inch display chosen for cost ($67) and distance read balance.
Optional 850 Nanometer illumination LED strip (Amazon SMD3528-120-IR Infrared (850nm) $25) and 850 NM transparent cover (EBAY jiuji_1206 389211071592 $30) for stealth without impacting LPR readability.
